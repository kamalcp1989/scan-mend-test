...
/**
 * <p>UnknownMessageException represents an error thrown during a message processing task.
 ...
 *
 * @version $Id: UnknownMessageException.java 16724 2014-02-04 16:50:31Z alehane $
 * @author njones
 *
 */
public class UnknownMessageException extends FatalMessageException {
     ...
     */
    public UnknownMessageException(final String message, final Throwable cause) {
        super(message, cause);
    }
